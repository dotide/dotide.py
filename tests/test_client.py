...
class TestClient(unittest.TestCase):
    ...
    def test_create_datastream(self):
        self.client.session.request.return_value = mock_response(201,
                                                                 json.dumps(self.datastream))
        datastream = self.client.create_datastream(data=json.dumps(self.datastream))
    ...
    def test_update_datastream(self):
        self.client.session.request.return_value = mock_response(200,
                                                                 json.dumps(self.datastream))
        datastream = self.client.update_datastream(self.datastream['id'],
